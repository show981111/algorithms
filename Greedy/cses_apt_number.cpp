...
/**
 * How do I know it is greedy?
 *
 * Key of greedy. Prove if it is optimal!
 * Making a best choice for myself -> leads to the optimal decision for everyeone!
 *
 * If "I" choose the smallest apartment for myself,
 * It gives all others who requires bigger apartment a biggest choices
 * -> Optimal
 */
int main()
{
